...
s3cmd -c ~/.s3cfg put build/artifacts/javarepl-intellij-$JAVAREPL_BUILD_NUMBER.zip s3://albertlatacz.published/javarepl/intellij-plugin/javarepl-intellij.zip
...
s3cmd -c ~/.s3cfg put build/artifacts/javarepl-$JAVAREPL_BUILD_NUMBER.jar s3://albertlatacz.published/javarepl/javarepl.jar
